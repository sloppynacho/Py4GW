...
class MapID:
    ...
    def __eq__(self, other: "MapID") -> bool: ...
    def __ne__(self, other: "MapID") -> bool: ...
...
class PyMap:
    ...
    def RegionFromDistrict(self, district: int) -> int: ...
    def LanguageFromDistrict(self, district: int) -> int: ...
