...
def Snowman(bot: Botting):
    ...
    _queue_dialog_by_mode(bot, -23884, 13954, 0x84)
    ...
    _queue_dialog_by_mode(bot, -14078.00, 15449.00, 0x84)
    ...
    _queue_dialog_by_mode(bot, -12482.00, 3924.00, 0x84)
    ...
    bot.Items.LootItems()
    _queue_dialog_by_mode(bot, -16093.00, -10723.00, 0x84)
