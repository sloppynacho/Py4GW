...
def farm_froggy_routine(bot: Botting) -> None:
    ...
    bot.States.AddCustomState(lambda: S_WhitelistModels(BOSS_KEY_MODEL_IDS), "Whitelist torchs")
    bot.Multibox.UseAllConsumables()
    ...
    bot.States.AddHeader("Level 3 - Path to Boss")
    ...
    bot.States.AddCustomState(resolve_BOGROOT_fight, "Resolve BOGROOT Fight")
